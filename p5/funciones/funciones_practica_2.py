...
def get_cantidad_electrodomesticos(metadata):
...
def get_tipo(metadata, id_electrodomestico):
...
def get_casa(metadata, id_electrodomestico):
...
def get_nombre(metadata, id_electrodomestico):
    '''Devuelve el nombre del electrodoméstico '''
    # COMPLETAR
    tipo=int(get_tipo(metadata, id_electrodomestico))
...
def get_ids(metadata):
    ...
    # COMPLETAR
    array=np.arange(0,get_cantidad_electrodomesticos(metadata))
    return array
    
def get_ids_por_tipo(metadata, tipo):
    '''Devuelve los ids correspondientes a cierto tipo'''
    # COMPLETAR
    lista=list()
    for i in range(1,get_cantidad_electrodomesticos(metadata)):
        if get_tipo(metadata, i)==tipo:
            lista.append(i) 
    return lista
#REMIRAR 


def get_ids_por_casa(metadata, casa):
    '''Devuelve los ids correspondientes a cierta casa'''
    # COMPLETAR
    lista_casa=list()
    for i in range(0,get_cantidad_electrodomesticos(metadata)):
        if get_casa(metadata, i)==casa:
            lista_casa.append(i) 
    return lista_casa
